...
import 'package:ship_management/models/map-file-data.dart';
import 'package:ship_management/services/location/location_service.dart';
import 'package:ship_management/utils/map/markerdemo-contextmenubuilder.dart';
import 'package:ship_management/utils/map/markerdemo-datastore.dart';
import 'package:ship_management/utils/map/rotation-overlay.dart';
...
class MapViewPageState2 extends State<MapViewPage2> {
  ...
  void initState() {
    super.initState();
     lat = widget.mapFileData.initialPositionLat;
     long = widget.mapFileData.initialPositionLong;
  ...
  ViewModel _createViewModel() {
    ...
    viewModel.setMapViewPosition(lat,
        long);
