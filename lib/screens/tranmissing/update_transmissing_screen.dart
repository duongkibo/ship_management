...
class UpdateTransmissingScreen extends StatefulWidget {
  const UpdateTransmissingScreen({Key? key}) : super(key: key);

  @override
  State<UpdateTransmissingScreen> createState() =>
      _UpdateTransmissingScreenState();
}

class _UpdateTransmissingScreenState extends State<UpdateTransmissingScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await controller.initDataUpdate();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xff1D8BC2),
        title: Text('Cập Nhật Nhật Ký Chuyền Tải'),
      ),
      ...
      floatingActionButton: Padding(
        ...
        child: ElevatedButton(
          onPressed: () async {
            await controller.updateTransmissing();
          },
          child: Text('Cập nhật'),
